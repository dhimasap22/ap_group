    ...
    <div class="container-fluid mb-0 pb-0">
        <div class="row clearfix">
            <div class="col-lg-4">
                <div class="card">
                    <div class="body">
                        <form action="<?= site_url('laporan/laporanPembelian/show_data_lap_pembelian') ?>" method="post">
                            <div class="row">
                                <div class="col-md-8">
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                ...
                                <tbody>
                                    ...
                                    $no = 0;
                                    $gtotal = 0;
                                    foreach ($lap_pembelian as $pembelian) :
                                        $gtotal += $pembelian->total;
                                    ?>
                                        <tr>
                                            <td class="text-center"><?= $no = $no + 1 ?></td>
                                            <td class="text-center"><?= $pembelian->id_pembelian ?></td>
                                            <td class="text-center"><?= format_indo($pembelian->tanggal_pembelian) ?></td>
                                            <td class="text-center"><?= $pembelian->jumlah_beli ?></td>
                                            <td class="text-right">Rp <?= number_format($pembelian->harga_satuan) ?></td>
                                            <td class="text-right">Rp <?= number_format($pembelian->total) ?></td>
                                        </tr>
